...
pub fn add_hot_reloading() -> List(Node) {
...
fn hot_reloading() -> List(Node) {
  [
    html.div(
      [
        attr.Attr("hx-get", "/reload"),
        attr.Attr("hx-trigger", "every 0.5s"),
        attr.Attr("hx-target", "#hot-reload"),
      ],
      [
        html.div([attr.id("hot-reload")], [
          html.Comment(
